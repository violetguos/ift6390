...
% 					\end{equation*}
                ...
                % Let's go over this together tomorrow just to be safe
...
%\begin{equation*}
%\begin{split}
%\pdv{}{\sigma_{ii} ^2} &= \sum_{(x,y) \in D} \sum_{i = 1}^{d} - \frac{1}{2}(x_{i}^{(j)} - \mu_{i})^2 \frac{1}{\sigma_{ii} ^4} + \frac{1}{2}\sum_{j = 1}^{n} \sum_{i = 1}^{d} \frac{2 \pi}{2\pi \sigma_{ii} ^2}\\
%&=  \sum_{j = 1}^{n} \sum_{i = 1}^{d} - \frac{1}{2}(x_{i}^{(j)} - \mu_{i})^2 \frac{1}{\sigma_{i} ^4} + \frac{1}{2}\sum_{j = 1}^{n} \sum_{i = 1}^{d} \frac{1}{ \sigma_{i} ^2}\\
%&= \sum_{j = 1}^{n}  \sum_{i = 1}^{d} \frac{1}{2} [ -(x_{i}^{(j)} - \mu_{i})^2 \frac{1}{\sigma_{i} ^4} + \frac{1}{\sigma_{i} ^2}]\\
%\end{split}
%\end{equation*}
...
%\begin{equation*}
% \begin{split}
% \sum_{j = 1}^{n}\sum_{i = 1}^{d} (x_{i} - \mu_{i})^2 \frac{1}{\sigma_{i} ^4} 
%	&=\sum_{j = 1}^{n} \sum_{i=1}^{d}  \frac{1}{\sigma_{i} ^2}\\
%\sum_{j = 1}^{n}\sum_{i = 1}^{d} (x_{i} - \mu_{i})^2 
% &= \sum_{j = 1}^{n}\sum_{i=1}^{d}  \sigma_{i} ^2\\
%\sigma_{i}^2 &= \frac{\sum_{j = 1}^{n} \sum_{i = 1}^{d} (x_{i} - \mu_{i})^2}{\sum_{j %= 1}^{n}\sum_{i=1}^{d}}\\
%\sigma_{i}^2 &= (x_{i} - \mu_{i})^2\\
%\end{split}
%\end{equation*}
